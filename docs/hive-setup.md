...
Last step, you just need to edit the custom miner section with the address of the pugdag node you're mining to. This needs the full ip/port so it'll look similar to `192.168.0.12:26589` save the changes after you're finished
